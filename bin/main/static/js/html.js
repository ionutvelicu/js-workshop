...
var Html = (function () {
    ...
    var orderStatusesTemplate = Handlebars.compile($('#order-statuses').html());
    ...
    var showEditStatusField = function () {
        $('#editStatusTD').show()
        $('#displayStatusTD').hide()
    }
    
    var hideEditStatusField = function () {
        $('#editStatusTD').hide()
        $('#displayStatusTD').show()
    }
    ...
    return {
        ...
        showEditStatusField:    showEditStatusField,
        hideEditStatusField: 	hideEditStatusField,
        orderInfoTemplate:      orderInfoTemplate,
        orderStatusesTemplate:  orderStatusesTemplate
    }
})()